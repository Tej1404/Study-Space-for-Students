      ...
      <div className='container shadow mt-4'>
        <div className="dropdown mb-5 text-center">
          ...
          <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            <li><Link className="dropdown-item" to="3rdsemnotes" >3rd Sem</Link></li>
            <li><Link className="dropdown-item" to="4thsemnotes" >4th Sem</Link></li>
            <li><Link className="dropdown-item" to="5thsemnotes" >5th Sem</Link></li>
