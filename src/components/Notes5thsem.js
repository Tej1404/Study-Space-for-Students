...
function Notes5thsem() {
  let year_1 = [
    {
      ...
      syll: [
        ...
        },
        {
          ...
          u_link:
            "https://docs.google.com/presentation/d/1qYqWxv3eVvrk6YvkoLswn8PerrH7vfC9/edit#slide=id.p1",
        },
        {
          pic: notes,
          unit_id: "3",
  ...
  sessionStorage.setItem("semTitle","5th Semester")
  return (
    <div className="container text-center">
      <p className="display-5 semTitle">5th Semester Notes</p>
