...
function Notes5thsem(){
    ...
    return (
        <div className='container text-center'>
            <p className='display-5 semTitle'>5th Semister Notes</p>
            <div className="accordion" id="accordianexample" >
            {
                year_1.map((subject,ind)=>
                        <div className="accordion-item" key={subject.subject_id}>
                            <h2 className="accordion-header" id={subject.subject_id+"Heading"}>
                            <button className={ind==0?"accordion-button ":"accordion-button collapsed" } type="button" data-bs-toggle="collapse" data-bs-target={"#"+subject.subject_id+"Content"} aria-expanded="true" aria-controls={subject.subject_id+"-content"}>
                            {subject.subject_name}
                            </button>
                            </h2>
                            <div id={subject.subject_id+"Content"} className={ind===0 ?"accordion-collapse collapse show":"accordion-collapse collapse"} aria-labelledby={subject.subject_id+"Heading"} data-bs-parent="#accordianexample">
                            <div className="accordion-body">
                                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3" id={'myItems'}>
                                    {
